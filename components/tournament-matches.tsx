...
const groupStageMatches = {
  grupoA: [
    {
      id: 1,
      team1: { name: 'García / Martínez', score: [6, 6] },
      team2: { name: 'López / Fernández', score: [3, 4] },
      court: 'Cancha 1',
      time: '09:00',
      status: 'Finalizado',
      date: 'Jueves 14 Abril',
    },
    {
      id: 2,
      team1: { name: 'Rodríguez / Sánchez', score: [6, 6] },
      team2: { name: 'Pérez / González', score: [4, 3] },
      court: 'Cancha 2',
      time: '09:00',
      status: 'Finalizado',
      date: 'Jueves 14 Abril',
    ...
    {
      id: 3,
      team1: { name: 'García / Martínez', score: [7, 6] },
      team2: { name: 'Rodríguez / Sánchez', score: [5, 4] },
      court: 'Cancha 1',
      time: '11:00',
      status: 'Finalizado',
      date: 'Jueves 14 Abril',
  ...
  grupoB: [
    {
      id: 4,
      team1: { name: 'Jiménez / Ruiz', score: [6, 6] },
      team2: { name: 'Moreno / Álvarez', score: [2, 3] },
      court: 'Cancha 3',
      time: '09:00',
      status: 'Finalizado',
    ...
    {
      id: 5,
      team1: { name: 'Díaz / Torres', score: [6, 4, 6] },
      team2: { name: 'Ramírez / Castro', score: [4, 6, 3] },
      court: 'Cancha 4',
      time: '09:00',
      status: 'Finalizado',
      date: 'Viernes 15 Abril',
    },
    {
      id: 6,
      team1: { name: 'Jiménez / Ruiz', score: [6, 6] },
      team2: { name: 'Díaz / Torres', score: [3, 4] },
      court: 'Cancha 3',
      time: '11:00',
      status: 'Finalizado',
      date: 'Viernes 15 Abril',
  ...
  grupoC: [
    {
      id: 7,
      team1: { name: 'Silva / Ortiz', score: [] },
      team2: { name: 'Vargas / Mendoza', score: [] },
      court: 'Cancha 5',
      time: '14:00',
      date: 'Viernes 15 Abril',
      status: 'Programado',
    ...
    {
      id: 8,
      team1: { name: 'Herrera / Campos', score: [] },
      team2: { name: 'Navarro / Reyes', score: [] },
      court: 'Cancha 6',
      time: '14:00',
      date: 'Viernes 15 Abril',
      status: 'Programado',
...
export function TournamentMatches({
  ...
  return (
    <div>
      <div className="mb-8">
        <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-3 text-balance">
          Partidos
        </h3>
      ...
      <Tabs defaultValue="grupos" className="w-full">
        ...
        <TabsContent value="grupos" className="space-y-8">
          <Tabs defaultValue="grupoA" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-6 h-auto">
              <TabsTrigger value="grupoA" className="text-sm md:text-base py-2">
                Grupo A
              </TabsTrigger>
              <TabsTrigger value="grupoB" className="text-sm md:text-base py-2">
                Grupo B
              </TabsTrigger>
              <TabsTrigger value="grupoC" className="text-sm md:text-base py-2">
                Grupo C
              </TabsTrigger>
            </TabsList>

            {Object.entries(groupStageMatches).map(([group, matches]) => (
        ...
        <TabsContent value="eliminatoria" className="space-y-8">
