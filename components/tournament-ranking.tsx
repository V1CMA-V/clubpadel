            ...
            return (
              ...
              >
                ...
                <div className="md:col-span-1 flex items-center gap-3 md:gap-0">
                  {Icon ? (
                    <div
                      className={`w-10 h-10 rounded-full ${rank.bgColor} flex items-center justify-center`}
                    >
                  ...
                  <span className="md:hidden font-semibold text-foreground ml-2">
                    {rank.team}
                  </span>
                </div>
                ...
                <div className="md:col-span-7 grid grid-cols-3 gap-4 text-center">
                  <div>
                    <p className="text-sm text-muted-foreground md:hidden mb-1">
                      Puntos
                    </p>
